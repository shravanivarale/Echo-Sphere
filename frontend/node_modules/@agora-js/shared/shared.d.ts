...
export declare interface ClientConfig {
    ...
    mode: SDK_MODE;
    /**
     * AI 客户端模式。开启后，SDK 会在创建客户端时准备 AI QoS 所需的媒体 DataChannel。
     *
     * @自从
     * <br>&emsp;&emsp;&emsp;*4.24.8*
     */
    /** @en
     * AI client mode. When enabled, the SDK prepares the media DataChannel required by AI QoS
     * while creating the client.
     *
     * @since
     * <br>&emsp;&emsp;&emsp;*4.24.8*
     */
    aiClientMode?: boolean;
    /**
...
export declare const MUTABLE_PARAMS: {
    ...
    /** 请求 AP 时，向 detail 中追加自定义字段 */
    AP_REQUEST_DETAIL_EXTEND: any;
    /**
     * 是否开启 角色 选取边缘节点
     */
    ...
    /**
     * 是否上报/启用 flexiblePC（二次 connect 干净路径；默认关）
     */
    FLEXIBLE_PC: boolean;
    /**
     * 是否开启预订阅, 因为不能 pre_pc
    ...
    /**
     * 是否允许 join v4 下由 ICE connected 提前完成 client.join
     * 关闭时仍保留预建联 PC，仅沿用 joinResponse 判定入会成功
     */
    ENABLE_ICE_EARLY_JOIN: boolean;
};
...
export declare class SDKStore {
    ...
    get aiClientMode(): boolean;
    set aiClientMode(val: boolean);
    ...
    get dcId(): number;
    set mediaDcId(mediaDcId: number);
    get mediaDcId(): number;
    ...
    set flexiblePC(val: boolean);
    get flexiblePC(): boolean;
