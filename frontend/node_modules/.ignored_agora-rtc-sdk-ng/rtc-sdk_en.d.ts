...
export declare interface IAgoraRTC extends EventEmitter {
    ...
    /**
     * Installs an optional SDK service.
     *
     * For ESM, import an optional service from `agora-rtc-sdk-ng/services/*` and install it with this method.
     *
     * ```javascript
     ...
     * ```
     *
     * @param plugin The service to install.
     * @returns The current AgoraRTC object.
     */
    use(plugin: IAgoraRTCServicePlugin): IAgoraRTC;
}
...
/**
 * An extension service that can be installed into the SDK through {@link IAgoraRTC.use}.
 */
declare interface IAgoraRTCServicePlugin<T = any, R = any> {
    name: string;
    create: (...args: any[]) => T;
