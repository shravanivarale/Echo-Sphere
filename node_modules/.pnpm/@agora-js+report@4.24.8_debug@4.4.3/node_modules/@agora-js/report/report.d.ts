...
export declare interface EventReportJoinGatewayMessage extends EventReportBase {
    ...
    iceConnectedElapse?: number | null;
    joinResponseElapse?: number | null;
    winner?: "ice" | "joinres";
    preload: number;
    installId: string;
    isABTestSuccess: number;
...
export declare interface EventReportJoinGatewayParams {
    ...
    /** 以下字段只供 sdp endpoint 首次 join 上报使用，时间均为绝对时间戳。 */
    iceConnectedAt?: number;
    joinResponseAt?: number;
    winnerAt?: number;
    winner?: "ice" | "joinres";
    /** endpoint timing 上报时，用收到 p2pok 的时刻更新 lastJoinSuccessTime。 */
    reportAt?: number;
}
